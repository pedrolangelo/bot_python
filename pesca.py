...
def pescar():
    ...
    comida      = pyautogui.locateOnScreen('imagens/comida_vermelha.png', grayscale=False, confidence=0.4)
    agua        = pyautogui.locateOnScreen('imagens/agua_vermelha.png', grayscale=False, confidence=0.4)
